...
import co.com.wenstore.model.events.gateways.EventsGateway;
...
public class ReactiveEventsGateway implements EventsGateway {
    public static final String SOME_EVENT_NAME = "notifyOrder";
    ...
    public Mono<Void> emit(Object event) {
        ...
        return from(domainEventBus.emit(
                new DomainEvent<>(SOME_EVENT_NAME, UUID.randomUUID().toString(), event)));
    }
}
